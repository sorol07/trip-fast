...
<html class="no-js" lang="zxx">
  ...
  <body>
            ...
            <div class="row align-items-center justify-content-between">
              <div class="col-auto">
                <div class="header-logo">
                  <a href="index.html"><img src="assets/img/travgo_logo.png" alt="TravGo"/></a>
                </div>
              </div>
              <div class="col-auto">
            ...
            <div class="hero-inner">
              <div class="hero-card">
                ...
                <div class="hero-card_content">
                  ...
                  <h4 class="hero-card_price">
                    <span class="currency">$750.00</span>/Person
                  </h4>
            ...
            <div class="hero-inner">
              <div class="hero-card">
                ...
                <div class="hero-card_content">
                  ...
                  <span><i class="fa-light fa-clock"></i>6 Days</span>
                  <a href="destination-details.html" class="th-btn style2"
                    >Book Now</a
                  >
                </div>
              </div>
            ...
            <div class="about-item-wrap">
              <div class="about-item">
                ...
                <div class="about-item_centent">
                  <h5 class="box-title">What is Travgo Travel Agency?</h5>
                  <p class="about-item_text">
                    Travgo is a modern travel agency designed to cater to the evolving needs of travelers.
                    With a focus on innovation, convenience, and trust, Travgo specializes in creating tailored travel solutions—whether it’s a solo adventure, family vacation, romantic getaway, or business trip.
                    From planning itineraries to booking flights, accommodations, and activities, Travgo simplifies the travel process so you can focus on enjoying the journey.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="offer-deals-accordion">
          <div class="row">
                ...
                <div class="accordion-item-wrapp" id="offerDeals">
                  ...
                  <div class="accordion-item-content">
                    ...
                    >
                      <div
                        ...
                        data-img="assets/img/normal/offer_img_2.jpg"
                      >
                    ...
                    <div class="accordion-item-content">
                      ...
                      >
                        <div
                          class="accordion-item"
                          data-img="assets/img/normal/offer_img_3.jpg"
                        >
                    ...
                    <div class="accordion-item-content">
                      ...
                      >
                        <div
                          class="accordion-item"
                          data-img="assets/img/normal/offer_img_4.jpg"
                        >
                    ...
                    <div class="accordion-item-content">
                      ...
                      >
                        <div
                          class="accordion-item"
                          data-img="assets/img/normal/offer_img_5.jpg"
                        >
                  ...
                  <div id="tabs-content">
                    <div id="tab1" class="according-img-tab">
                      <img src="assets/img/normal/offer_img_1.jpg" alt="" />
                    </div>
                    <div id="tab2" class="according-img-tab">
                      <img src="assets/img/normal/offer_img_2.jpg" alt="" />
                    </div>
                    <div id="tab3" class="according-img-tab">
                      <img src="assets/img/normal/offer_img_3.jpg" alt="" />
                    </div>
                    <div id="tab4" class="according-img-tab">
                      <img src="assets/img/normal/offer_img_4.jpg" alt="" />
                    </div>
                    <div id="tab5" class="according-img-tab">
                      <img src="assets/img/normal/offer_img_5.jpg" alt="" />
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-xl-5">
              ...
              <ul
                class="offer-deals-counter counter-list"
                data-offer-date="12/8/2024"
              >
                <li>
    ...
    <section
      class="tour-sec2 position-relative overflow-hidden bg-top-center z-index-3 space-top"
      id="tour-sec"
      data-pos-for=".counter-sec2"
      data-sec-pos="bottom-half"
      data-bg-src="assets/img/bg/tour_bg_2.jpg"
    >
      <div class="container">
        ...
        <div class="slider-area tour-slider">
          <div
            class="swiper th-slider tourSlider2 slider-drag-wrap has-shadow"
            id="tourSlider2"
          ...
          >
            <div class="swiper-wrapper">
              <div class="swiper-slide">
                <div class="tour-card th-ani gsap-cursor">
                  <div class="tour-card_img global-img">
                    <img src="assets/img/tour/tour_2_1.jpg" alt="image" />
                  </div>
              ...
              <div class="swiper-slide">
                <div class="tour-card th-ani gsap-cursor">
                  <div class="tour-card_img global-img">
                    <img src="assets/img/tour/tour_2_2.jpg" alt="image" />
                  </div>
                  <div class="tour-content">
                    <h3 class="box-title">
              ...
              <div class="swiper-slide">
                <div class="tour-card th-ani gsap-cursor">
                  <div class="tour-card_img global-img">
                    <img src="assets/img/tour/tour_2_3.jpg" alt="image" />
                  </div>
                  <div class="tour-content">
                    <h3 class="box-title">
              ...
              <div class="swiper-slide">
                <div class="tour-card th-ani gsap-cursor">
                  <div class="tour-card_img global-img">
                    <img src="assets/img/tour/tour_2_4.jpg" alt="image" />
                  </div>
                  <div class="tour-content">
                    <h3 class="box-title">
    ...
    >
      <div class="container">
        ...
        <div
          class="shape-mockup dance2 d-none d-xl-block"
          data-bottom="0%"
          data-right="-15%"
        >
    ...
    <div
      class="gallery-area2 bg-top-center space"
      ...
      <div class="container">
        ...
        >
          <div class="col-lg-7">
            ...
            <p class="sec-text style2 text-title mb-50">
      ...
      <div class="container th-container2">
        <div class="row gy-24 gx-24 justify-content-center">
          <div class="col-lg-3 gallery-box_wrapp">
            <div class="gallery-box">
              <div class="gallery-img global-img">
                <a href="assets/img/gallery/gallery_2_1.jpg" class="popup-image"
                  ><div class="icon-btn">
          ...
          <div class="col-lg-3 gallery-box_wrapp">
            <div class="gallery-box">
              <div class="gallery-img global-img">
                <a href="assets/img/gallery/gallery_2_2.jpg" class="popup-image"
                  ><div class="icon-btn">
                    <i class="fal fa-magnifying-glass-plus"></i>
                  </div>
                  <img
            ...
            <div class="gallery-box">
              <div class="gallery-img global-img">
                <a href="assets/img/gallery/gallery_2_3.jpg" class="popup-image"
                  ><div class="icon-btn">
                    <i class="fal fa-magnifying-glass-plus"></i>
                  </div>
                  <img
          ...
          <div class="col-lg-3 gallery-box_wrapp">
            <div class="gallery-box">
              <div class="gallery-img global-img">
                <a href="assets/img/gallery/gallery_2_4.jpg" class="popup-image"
                  ><div class="icon-btn">
                    <i class="fal fa-magnifying-glass-plus"></i>
                  </div>
                  <img
            ...
            <div class="gallery-box">
              <div class="gallery-img global-img">
                <a href="assets/img/gallery/gallery_2_5.jpg" class="popup-image"
                  ><div class="icon-btn">
                    <i class="fal fa-magnifying-glass-plus"></i>
                  </div>
                  <img
          ...
          <div class="col-lg-3 gallery-box_wrapp">
            <div class="gallery-box">
              <div class="gallery-img global-img">
                <a href="assets/img/gallery/gallery_2_6.jpg" class="popup-image"
                  ><div class="icon-btn">
                    <i class="fal fa-magnifying-glass-plus"></i>
                  </div>
                  <img
              ...
              <div class="testi-box hover-item">
                ...
                <div class="testi-box_profile">
                  <div class="testi-box_avater">
                    <span></span>
                    <img
                      src="assets/img/testimonial/testi_2_5.png"
                      alt="testimonial"
                    />
                  </div>
                  <div class="media-body">
    ...
    <section class="bg-smoke overflow-hidden space-top" id="blog-sec">
      <div class="container">
          ...
          <div class="row align-items-center justify-content-between">
            <div class="col-md-7">
              <div class="title-area mb-md-0">
                ...
                <h2 class="sec-title">News & Articles From TravGo</h2>
              </div>
            </div>
        ...
        <div class="shape-mockup shape1 d-none d-xxl-block" data-top="14%" data-right="-13%">
          <img src="assets/img/shape/shape_1.png" alt="shape" />
        </div>
        <div class="shape-mockup shape2 d-none d-xl-block" data-top="25%" data-right="-12%">
          <img src="assets/img/shape/shape_2.png" alt="shape" />
        </div>
        <div class="shape-mockup shape3 d-none d-xxl-block" data-top="20%" data-right="-18%">
          <img src="assets/img/shape/shape_3.png" alt="shape" />
        </div>
      </div>
    </section>
              ...
              <div class="widget footer-widget">
                ...
                <div class="th-widget-contact">
                  ...
                  <div class="info-box_text">
                    ...
                    <div class="details">
                      <p>
                        <a href="mailto:mailinfo00@demo.com" class="info-box_link">mailinfo00@demo.com</a>
                      </p>
                      <p>
                        <a href="mailto:support24@demo.com" class="info-box_link">support24@demo.com</a>
                      </p>
                    </div>
                  </div>
                  <div class="info-box_text">
